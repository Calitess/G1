...
{
    private SerializedProperty creatingWallProperty,gridProperty, gridSizeProperty,wallsProperty, undoProperty, randomProperty, raycastProperty, useCustomDistanceProperty, customDistanceProperty, backToDefaultProperty, rotatePrefabProperty;
